import { X, Mail, Building2, MapPin } from "lucide-react";

export default function OrganizationModal({ organization, onClose }) {
      ...
      <div className="bg-white w-[90%] max-w-4xl rounded-3xl shadow-2xl p-8 relative">
        ...
        <div className="flex items-center gap-6">
          <div className="w-28 h-28 rounded-full bg-indigo-100 flex items-center justify-center">
            <Building2 size={50} className="text-indigo-600" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="font-semibold text-lg">{organization.email}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-gray-400">Organization ID</p>

                <p className="font-semibold text-lg">#{organization.id}</p>
              </div>
            </div>
          </div>
        </div>
