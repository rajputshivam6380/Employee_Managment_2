...
export default function Home() {
  ...
  const fetchData = async () => {
    try {
      ...
      const employeeData = usersRes.data.filter(
      ...
      console.log("ORG API:", orgRes.data);

      setEmployees(employeeData);

      setOrganizations(
        Array.isArray(orgRes.data) ? orgRes.data : orgRes.data.data || [],
      );
  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      <Sidebar setType={setType} currentType={type} />
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="p-6">
          {type === "employee" && (
            <EmpTable employee={employees} organizations={organizations} />
          )}
